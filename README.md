...
3. 全局替换`teressssa`为仓库所有者ID; 全局替换`nonebot-plugin-aibot`为插件名; 全局替换`nonebot_plugin_example`为包名; 修改 python 徽标中的版本为你插件的运行所需版本
...
在 nonebot2 项目的根目录下打开命令行, 输入以下指令即可安装
    ...
    nb plugin install nonebot-plugin-aibot
...
<summary>pdm</summary>
    ...
    pdm add nonebot-plugin-aibot
</details>
<details>
<summary>poetry</summary>

    poetry add nonebot-plugin-aibot
</details>
<details>
<summary>conda</summary>

    conda install nonebot-plugin-aibot
</details>
